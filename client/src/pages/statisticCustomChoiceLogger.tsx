...
const StatisticCustomChoiceLoggerPage = () => {
    ...
    useEffect(() => {
        ...
        getProvider()
            .then((res) => {
                if (
                    ...
                    for (const item of res.data?.GetLoggerProvider) {
        ...
        getMarks()
            .then((res) => {
                if (
                    ...
                    for (const item of res.data?.GetLoggerMarks) {
                        if (item !== null && item !== undefined) {
                            temp.push(item);
                        }
                    }
        ...
        getModel()
            .then((res) => {
                if (
                    ...
                    for (const item of res.data?.GetLoggerModel) {
                        if (item !== null && item !== undefined) {
                            temp.push(item);
                        }
                    }
        ...
        getStatisticCustomMeter()
            .then((res) => {
                if (
                    res?.data?.GetStatisticCustomChoiceLogger !== null &&
                    res?.data?.GetStatisticCustomChoiceLogger !== undefined
                ) {
                    //@ts-ignore
                    setStatisticData([
                        ...res.data.GetStatisticCustomChoiceLogger,
                    ]);
                }
            })
            .catch((err) => console.log(err));
...
export default StatisticCustomChoiceLoggerPage;
